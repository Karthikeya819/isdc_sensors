...
def loop():
  ...
  print("CO gas concentration is %.1f"%gas_concentration)
  gas_concentration = mics.get_gas_ppm(CH4)
  print("CH4 gas concentration is %.1f"%gas_concentration)
  gas_concentration = mics.get_gas_ppm(C2H5OH)
  print("C2H5OH gas concentration is %.1f"%gas_concentration)
  gas_concentration = mics.get_gas_ppm(H2)
  print("H2 gas concentration is %.1f"%gas_concentration)
  gas_concentration = mics.get_gas_ppm(NH3)
  print("NH3 gas concentration is %.1f"%gas_concentration)
  gas_concentration = mics.get_gas_ppm(NO2)
  print("NO2 gas concentration is %.1f"%gas_concentration)
  time.sleep(1)
  #mics.sleep_mode()
